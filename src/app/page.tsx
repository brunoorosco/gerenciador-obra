...
const menuItem = [
  ...
  { id: 3, text: 'Registro de Frequência', link: '/registro-frequencia' },
    ...
    <main className='grid-cols-1 grid md:grid-cols-4 mt-3 md:min-h-screen max-w-xl mx-auto items-center px-3 text-center gap-5 box-border '>
      {menuItem.map((menu: any) => (
        <div
          ...
          className='bg-slate-50 rounded-md shadow-sm cursor-pointer h-28 flex flex-col justify-center items-center'
          key={menu.id}
        >
